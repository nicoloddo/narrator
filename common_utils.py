...
def check_image_quality(image, count_frames, debugging=False):
    ...
    hue_uniformity_threshold = (
        HUE_UNIFORMITY_THRESHOLD  # Adjust this threshold based on your needs
    )
    sat_uniformity_threshold = (
        SATURATION_UNIFORMITY_THRESHOLD  # Adjust this threshold based on your needs
    )
    ...
    lacks_color_variance = (
        sat_std < sat_uniformity_threshold or hue_std < hue_uniformity_threshold
    )
