...
export FIRST_IMAGE_PROMPT="You are starting the documentary. This is the first thing to show."
export NEW_IMAGE_PROMPT="Continue the documentary by talking about this image. You are Sir David Attenborough"
export ELEVENLABS_VOICE_ID=Uql9NfKStxPGW1kwk20...breakelevenlabs...T
export PLAYHT_VOICE_ID="s3://voice-cloning-zero-shot/e8751c5e-c28e-4811-8b4f-992dfad28887/original/manifest.json"
export MAX_TIMES="1"
export DARKNESS_THRESHOLD="15"
export SATURATION_UNIFORMITY_THRESHOLD="70"
export HUE_UNIFORMITY_THRESHOLD="100"